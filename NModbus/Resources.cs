...
namespace NModbus
{
    internal static class Resources
    {
        ...
        public const string IllegalFunction = "The function code received in the query is not an allowable action for the server. This may be because the function code is only applicable to newer devices, and was not implemented in the unit selected.It could also indicate that the server is in the wrong state to process a request of this type, for example because it is unconfigured and is being asked to return register values.";
        ...
        [Obsolete("Master/Slave terminology is deprecated and replaced with Client/Server. Use ServerDeviceBusy instead.")]
        ...
        [Obsolete("Master/Slave terminology is deprecated and replaced with Client/Server. Use ServerDeviceFailure instead.")]
        ...
        [Obsolete("Master/Slave terminology is deprecated and replaced with Client/Server. Use ServerExceptionResponseFormat instead.")]
        public const string SlaveExceptionResponseFormat = "Function Code: {1}{0}Exception Code: {2} - {3}";

        [Obsolete("Master/Slave terminology is deprecated and replaced with Client/Server. Use ServerExceptionResponseInvalidFunctionCode instead.")]
        public const string SlaveExceptionResponseInvalidFunctionCode = "Invalid function code value for SlaveExceptionResponse.";

        public const string ServerDeviceBusy = "Specialized use in conjunction with programming commands. The server is engaged in processing a long–duration program command.The client should retransmit the message later when the server is free.";

        public const string ServerDeviceFailure = "An unrecoverable error occurred while the server was attempting to perform the requested action.";

        public const string ServerExceptionResponseFormat = "Function Code: {1}{0}Exception Code: {2} - {3}";

        public const string ServerExceptionResponseInvalidFunctionCode = "Invalid function code value for ServerExceptionResponse.";
        ...
        public const string Unknown = "Unknown server exception code.";
