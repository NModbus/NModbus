...
namespace NModbus.Device
{
    ...
    /// </summary>
    internal class ModbusMasterRtuOverTcpConnection : ModbusMasterTcpConnection, IDisposable
    {
        ...
        protected override async Task HandleRequestAsync()
        {
            try
            {
                while (true)
                {
                    ...
                    //获得从站对象
                    IModbusMessage response = (_slaveNetwork as ModbusRtuOverTcpSlaveNetwork).ApplyRequest(request);
